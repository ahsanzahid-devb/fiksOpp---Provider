#!/bin/bash
# Script to generate a new upload keystore after Google Play upload key reset
# Run this AFTER you've completed the upload key reset in Google Play Console
...
read -p "Enter keystore filename (e.g., upload-keystore.jks): " KEYSTORE_NAME
